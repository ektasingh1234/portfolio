        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {QUICK_STATS.map((stat, idx) => (
            <motion.div
              ...
              className="glass-card p-5 rounded-2xl flex flex-col justify-between hover:border-indigo-300 transition-all bg-white"
            >
              ...
              <div>
                <motion.div
                  ...
                  className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight font-sans text-indigo-950 hover:text-indigo-600 transition-colors"
                >
                  {stat.value}
                </motion.div>
