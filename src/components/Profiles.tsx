...
export default function Profiles() {
  ...
  return (
    <section id="profiles" className="py-20 lg:py-28 bg-slate-50 border-b border-slate-200/80">
          ...
          {profiles.map((prof, idx) => {
            ...
            return (
              <motion.a
                ...
                whileHover={{ y: -6 }}
                className="glass-card bg-white p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between group transition-all"
              >
                <div>
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex items-center justify-between font-mono text-xs font-bold text-indigo-600 group-hover:translate-x-1 transition-transform">
